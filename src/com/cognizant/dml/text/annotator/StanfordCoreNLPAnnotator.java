...
public class StanfordCoreNLPAnnotator extends JCasAnnotator_ImplBase {
  private static final Log log=LogFactory.getLog(StanfordCoreNLPAnnotator.class);
  private StanfordCoreNLP processor;

  public static final String PARAM_ANNOTATORS = ConfigurationParameterFactory.createConfigurationParameterName(
		  StanfordCoreNLPAnnotator.class,
      "annotators");

  @ConfigurationParameter(
      mandatory = true,
      defaultValue = "tokenize, ssplit, pos, lemma, ner, parse, dcoref",
      description = "comma seperated Stanford CoreNLP annotator modules, refer Stanford documentation.")
  ...
  public void process(JCas jCas) throws AnalysisEngineProcessException {
	//log.info("STANFORD("+jCas.getViewName()+"): "+jCas.getDocumentText());
    ...
    if (null!=lastNETag && !lastNETag.equals("O")) {
      NamedEntityMention ne = new NamedEntityMention(jCas, lastNEBegin, lastNEEnd);
      ne.setMentionType(lastNETag);
      ne.addToIndexes();
    }
